...
public class ServerClientInfo {
	...
	// a client is neither in room nor in game when it is in lobby
	private boolean inLobby = true;
	// a client is not in lobby but in a room when it is in a game
	private boolean inGame = false;
	// a client is not necessarily in a game when it is in a room
