...
public class TextItem {
	...
	/**
	 * Create a TextItem object that stores the given text and the texture for
	 * that text
	 * 
	 * @param text
	 *            The given text
	 * @param fontTexture
	 *            The given texture for that text with that font
	 * @throws Exception
	 */
	 ...
	 * 
	 * @param colour
	 *            The given colour represented as a Vector3f
	 */
