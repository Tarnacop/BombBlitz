...
public class AudioManager {
	...
	/**
	 * Sets a new value for the volume of the music Must be called before
	 * initialising the manager
	 *
	 * @param percent
	 *            The volume percent, ranging from 0 to 100
	 */
	...
	/**
	 * Sets a new value for the volume of the sound effects (all sounds but the
	 * music) Must be called before initialising the manager
	 *
	 * @param percent
	 *            The volume percent, ranging from 0 to 100
	 */
	...
	/**
	 * Sets a new value for the overall volume (both for the sound effects and
	 * the music) Must be called before initialising the manager
	 *
	 * @param percent
	 *            The volume percent, ranging from 0 to 100
	 */
	...
	/**
	 * Stops all the sounds from playing. The sound effects cannot be restarted
	 * after this
	 */
	 ...
	 *
	 * @param eventList
	 *            The list of events to be played
	 */
	 ...
	 *
	 * @param gainControl
	 *            The MASTER_GAIN control of the <code>Clip</code>
	 * @param volume
	 *            The volume percent, ranging from 0 to 100
	 */
	static void setControlVolume(FloatControl gainControl, float volume) {
		...
		// System.out.println(linearMin + " -- " + linearVolume + " -- " +
		// linearMax);
		// System.out.println(gainControl.getMinimum() + " -- " +
		// (float)(20*Math.log10(linearVolume)) + " -- " +
		// gainControl.getMaximum());

		// float min = gainControl.getMinimum();
		// float max = gainControl.getMaximum();

		// gainControl.setValue(min + (max-min)*volume/100); // db; decreases
		// faster
		gainControl.setValue((float) (20 * Math.log10(linearVolume))); // linear
																		// formula;
																		// not
																		// so
																		// precise
